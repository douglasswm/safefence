export const REASON_CODES = {
  ...
  RBAC_USER_DENIED: "RBAC_USER_DENIED",
  RBAC_BOT_CAPABILITY_DENIED: "RBAC_BOT_CAPABILITY_DENIED",
  RBAC_BOT_ACCESS_DENIED: "RBAC_BOT_ACCESS_DENIED",
  RBAC_UNKNOWN_USER: "RBAC_UNKNOWN_USER"
} as const;
